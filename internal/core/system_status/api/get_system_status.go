...
func (api *API) GetSystemStatus(_ *models.GetSystemStatusInput) (*models.GetSystemStatusOutput, error) {
	return &models.GetSystemStatusOutput{
		...
		models.ComponentDataSources:    models.ComponentStatus{Status: models.StatusOK},
		models.ComponentDetections:     models.ComponentStatus{Status: models.StatusOK},
		models.ComponentDatalake:       models.ComponentStatus{Status: models.StatusOK},
	}, nil
}
