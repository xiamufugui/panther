...
export type ListDetectionsBreadcrumbFiltersValues = {
  logType: string;
  tags: string[];
};

const ALL_TYPES = 'All Types';
const filterKeys: (keyof Partial<ListDetectionsInput>)[] = ['logTypes', 'tags'];

const ListDetectionsBreadcrumbFilters: React.FC = () => {
  ...
  const initialFilterValues = React.useMemo(() => {
    ...
    return {
      ...
      tags: tags || [],
    } as ListDetectionsBreadcrumbFiltersValues;
  }, [requestParams]);

  const onFiltersChange = React.useCallback(
    ({ logType, ...rest }: ListDetectionsBreadcrumbFiltersValues) => {
  ...
  return (
    <Breadcrumbs.Actions>
      <Flex justify="flex-end">
        <Formik<ListDetectionsBreadcrumbFiltersValues>
          enableReinitialize
...
export default React.memo(ListDetectionsBreadcrumbFilters);
